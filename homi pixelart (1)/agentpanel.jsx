  ...
  return (
    <div className="col" style={{ gap: 8 }}>
      <div className="row" style={{ gap: 8 }}>
        <Pixel sprite={window.GLYPHS_HD.phone} scale={3} />
        <div>
...
function BrowserPreview({ transcript }) {
  ...
  return (
    <div className="col" style={{ gap: 8 }}>
      <div className="row" style={{ gap: 8 }}>
        <Pixel sprite={window.GLYPHS_HD.laptop} scale={3} />
        <div>
...
function AgentPanel({ homie, issue, property, onClose, palette }) {
  ...
  const def = window.HOMIE_HD_DEFS[homie.spriteIdx];
  const sponsorKey = def && def.sponsor;
  const sponsor = sponsorKey && window.SPONSORS[sponsorKey];
      ...
      <div className="panel" style={{ padding: 0 }}>
        ...
        <div style={{
          ...
          <div style={{ background: 'var(--c-line)', padding: 4, lineHeight: 0 }}>
            <window.HomieHD defIdx={homie.spriteIdx} scale={3} palette={palette} />
          </div>
          <div style={{ flex: 1 }}>
        ...
        {sponsor && (
          <div style={{
            ...
            <window.SponsorLogo keyName={sponsorKey} size={56} pixelated={true} />
            <div className="col" style={{ gap: 2, flex: 1 }}>
              <div className="pixel-font" style={{ fontSize: 8, color: 'var(--ui-muted)' }}>SPONSORED HOMIE</div>
              <div className="pixel-font" style={{ fontSize: 11, color: 'var(--ui-accent-2)' }}>{sponsor.name.toUpperCase()}</div>
              <div className="mono-font dim" style={{ fontSize: 14 }}>this homie is sponsored by {sponsor.name}</div>
            </div>
          </div>
        )}
        ...
        {issue && property && (
          <div style={{
            ...
            <Pixel sprite={window.GLYPHS_HD[window.ISSUE_TYPES[issue.type].glyph]} scale={3} />
...
function DispatchToast({ homie, issue, property, onDone }) {
  ...
  return (
    <div style={{
      ...
      <window.HomieHD defIdx={homie.spriteIdx} scale={2} />
